...
def generate_launch_description():
    ...
    )## In 'rotate' mode, the robot will pick the wheel, rotate it in the air, and place it back. In 'hold' mode, the robot will pick the wheel and hold it in the air without rotating, until the user terminates the program (e.g. Ctrl-C). This allows for testing the grasp and TF setup without performing the rotation motion."
