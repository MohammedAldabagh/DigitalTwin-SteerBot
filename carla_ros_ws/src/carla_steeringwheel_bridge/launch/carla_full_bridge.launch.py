"""
carla_full_bridge.launch.py — vehicle + sensor + piper bridges (no spawner, no G29).

WARNING: this launch starts carla_vehicle_bridge. Do NOT run it at the same time as
carla_g29_bus_drive.launch.py (which also starts carla_vehicle_bridge) — two bridges
would fight over apply_control() on the same vehicle.
"""
